...
- The bash tool's shell is /bin/sh where `echo -n` prints "-n" literally instead of suppressing the newline; to write a value to a file use printf or the write tool.
