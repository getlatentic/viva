...
;;;;
;;;; Viva's first world was a live Lisp image, which made it a research
...
(defpackage #:viva.mcp
  ...
  (:export #:serve #:handle #:*protocol-version* #:*server-name* #:*server-version*))

(defpackage #:viva.memory
  (:use #:cl)
  (:local-nicknames (#:a #:alexandria)
                    (#:tool #:viva.tool)
                    (#:env #:viva.env)
